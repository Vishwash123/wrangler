...
public class GrammarBasedParserTest {
  ...
  public void testAggregateStatsParsing() throws Exception {
    ...
    // Verify directive type indirectly via execution in AggregateStatsDirectiveTest
  }

  @Test(expected = RecipeException.class)
  public void testInvalidAggregateStatsParsing() throws Exception {
    String[] recipe = new String[] {
            "aggregate-stats :data_transfer_size" // Missing arguments
    };
    RecipeParser parser = TestingRig.parse(recipe);
