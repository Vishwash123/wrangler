...
/**
 * A token representing a time duration (e.g., "150ms", "2.1s") parsed from a recipe.
 */
@PublicEvolving
    ...
    private long parseNanos(String input) {
        ...
        try {
            ...
            switch (unit) {
                ...
                case "h": return (long) (value * 3600 * 1_000_000_000);
                case "d": return (long) (value * 24 * 3600 * 1_000_000_000);
